    ...
    <section id="section-text" class="no-top no-bottom mt70 sm-mt0">
        <div class="container">
            <div class="row align-items-center g-0 wow fadeInUp mb5" data-bgcolor="rgba(255,255,255,.9)">
                ...
                <div class="col-md-6 text-middle">
                    <div class="padding50">
                        <h1><span class="id-color">Featured Project</span></h1>
                        <p>
                    ...
                    <div class="accordion" id="accordionExample">
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    <div class="image-featured-accord row" style="background-size: cover;text-align-last: center;">
                                        <a class="col-md-4"  href="{{ url('img/featured/design1.jpg') }}" target="_blank">
                                            <img style="max-height: 500px;" src="{{ url('img/featured/design1.jpg') }}" alt="" class="img-responsive" />
                                        </a>
                                        <a class="col-md-4"  href="{{ url('img/featured/design2.jpg') }}" target="_blank">
                                            <img style="max-height: 500px;" src="{{ url('img/featured/design2.jpg') }}" alt="" class="img-responsive" />
                                        </a>
                                        <a class="col-md-4"  href="{{ url('img/featured/design3.jpg') }}" target="_blank">
                                            <img style="max-height: 500px;" src="{{ url('img/featured/design3.jpg') }}" alt="" class="img-responsive" />
                                        </a>
                                    </div>
                                    <br/>
                                    <p style="font-size: 20px">
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    <div class="image-featured-accord row" style="background-size: cover;text-align-last: center;">
                                        <a class="col-md-4" href="{{ url('img/featured/install1.png') }}" target="_blank">
                                            <img style="max-height: 500px;" src="{{ url('img/featured/install1.jpg') }}" alt="" class="img-responsive" />
                                        </a>
                                        <a class="col-md-4"  href="{{ url('img/featured/install2.png') }}" target="_blank">
                                            <img style="max-height: 500px;" src="{{ url('img/featured/install2.jpg') }}" alt="" class="img-responsive" />
                                        </a>
                                        <a class="col-md-4"  href="{{ url('img/featured/install3.png') }}" target="_blank">
                                            <img style="max-height: 500px;" src="{{ url('img/featured/install3.jpg') }}" alt="" class="img-responsive" />
                                        </a>
                                    </div>
                                    <br/>
                                    <p style="font-size: 20px">
