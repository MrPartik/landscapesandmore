                ...
                <div class="progress-steps mt-3">
                    <div class="row">
                        <div style="text-align-last: center">
                            ...
                            <p>
                                To check the status of your existing application, <strong style="color: var(--primary-color-1)">please enter the email address</strong> you used to create and verify your application. If you want to start your process with Michaelangelo's, submit your inquiry to our <a href="/contact-us">Contact Us Form</a>.
                            </p>
                        </div>
