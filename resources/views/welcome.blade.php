        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div id="logo">
                        <a href="index.html">
                            <img class="logo" src="images-interior-landing/logo.png" alt="">
                        </a>
                    </div>
                    <!-- logo close -->
                                            ...
                                            <div class="menu-content">
                                                <div class="row">
                                                    <div class="col-lg-3 col-md-12">
                                                        <ul>
                                                            <li><a href="11_index-interior-design.html">New: Interior Design</a></li>
                                                            <li><a href="index-product-slider.html">New: Product Slider</a></li>
